...
const CardClasses = ({ classesData }) => {
 ...
 return (
  <div
   ...
   onClick={() => Inertia.get(`/classes/${classesData.id}`)}
  >
   ...
   <div className="card-class-dif-level">
    {classesData.difficulty}
   </div>
   <div className="card-class-info">
    <h5
     className="card-class-skill-name"
     style={{
      "--colorCategory": `#${classesData.skill.category.color}`,
     }}
    >
    ...
    <h2 className="card-class-title">
     {classesData.title}
    </h2>
    <h3 className="card-class-teacher-name">
     {classesData.teacher.name}
    </h3>
   </div>
  </div>
 );
