 ...
 return (
  <Layout current_user={props.current_user}>
   ...
   >
    ...
    <h2 className="class-header-subtitle">
     {props.class.teacher.name}
    </h2>
   </div>
   <div>
    <ul className="class-menu">
     <li
      className={
       click == "about" ? "class-btn active" : "class-btn"
      }
     ...
     <li
      className={
       click == "review" ? "class-btn active" : "class-btn"
      }
   ...
   <div
    className={
     click == "about" ? "class-about" : "class-about off"
    }
   >
    <div className="class-details">
     ...
     <div className="class-time">
      ...
      <p className="class-details-subtitle">
       Time p/lesson
      </p>
     </div>
    </div>
   ...
   <div
    className={
     click == "review" ? "class-review" : "class-review off"
    }
   >
    <div className="class-review-header">
     <h1 className="home-title">
      What students think about this class?
     </h1>
    </div>
   </div>
  </Layout>
